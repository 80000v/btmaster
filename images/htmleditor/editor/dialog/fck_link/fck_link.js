...
oRegex.UriProtocol = /^(((http|https|ftp|news|thunder|flashget|ed2k|qqdl):\/\/)|mailto:)/gi ;

oRegex.UrlOnChangeProtocol = /^(http|https|ftp|news|thunder|flashget|ed2k|qqdl):\/\/(?=.)/gi ;
